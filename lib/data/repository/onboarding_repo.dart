...
import 'package:face4biz/data/model/response/onboarding_model.dart';
  ...
  Future<ApiResponse> getOnBoardingList() async {
    try {
      List<OnboardingModel> onBoardingList = [
        OnboardingModel('assets/images/onboarding_image_one.png', 'Welcome to Nesst', 'Here shopping is easy and fun with 50 thousands products, exclusive deals, offers and promotions.'),
